...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 04, 2025 at 08:55 AM
...
INSERT INTO `users` (`user_id`, `username`, `email`, `password_hash`, `first_name`, `last_name`, `birthday`, `country`, `profile_image`, `user_type`, `is_active`, `status`, `email_verified`, `created_at`, `updated_at`, `last_login`) VALUES
(1, 'admin', 'admin@movielab.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Admin', 'User', '1990-01-01', 'United States', NULL, 'admin', 1, 'Active', 1, '2025-11-28 10:16:15', '2025-11-28 10:16:15', NULL),
(2, 'Sasindu', 'sasindusanjana88@gmail.com', '$2y$10$F5rx9Lr2MQG0dmtayvWnJ.4f1kesCtuoubVQq29VxtigrtMj/DS6u', 'Sasindu', 'Sanjana', '2001-02-01', 'Sri Lanka', '/images/Profile.jpg', 'normal', 1, 'Active', 0, '2025-11-28 10:22:23', '2025-11-28 10:22:37', '2025-11-28 10:22:37'),
(3, 'Lochana', 'nimnalochana@gmail.com', '$2y$10$NbKKkpIG5Na08uxoWN1GcuGPHaBJMB.wn0ya4GVxfQxh0KK61WfEi', 'Nimna', 'lochana', '2006-05-25', 'Sri Lanka', '/images/UserProfile.jpg', 'admin', 1, 'Active', 0, '2025-11-28 12:02:49', '2025-12-04 07:39:50', '2025-12-04 07:39:50');
