...
<body class="bg-black text-white">
    ...
    <main class="container mx-auto px-4 py-8">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
            ...
            <div class="relative w-full sm:w-auto">
                <input type="text" placeholder="Search movies..." class="w-full sm:w-64 pl-10 pr-4 py-2 bg-gray-900 border border-gray-700 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-red-600 text-sm">
    ...
    <!-- Pro Pricing Modal -->
    <div id="pricing-modal" class="modal fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70">
        <div class="modal-content bg-gray-900 rounded-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            <div class="p-5 border-b border-gray-700 flex justify-between items-center">
                <h2 class="text-xl md:text-2xl font-bold">Upgrade to MoviLab Pro</h2>
                <button id="close-pricing-modal" class="text-gray-400 hover:text-white">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="p-5">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                    ...
                    <div class="bg-gray-800/30 rounded-lg p-5 border border-gray-700">
                        <h3 class="text-lg font-semibold mb-2">Weekly</h3>
                        <div class="mb-3">
                            <span class="text-2xl md:text-3xl font-bold">$4.99</span>
                            <span class="text-gray-400">/week</span>
                        </div>
                        <ul class="space-y-2 mb-4">
                            <li class="flex items-center">
                                <svg class="w-4 h-4 text-red-600 mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <button class="w-full py-2.5 bg-gray-700 text-white rounded-lg hover:bg-gray-600 transition-colors text-sm">
                            Start Free Trial
                        </button>
                    </div>
                    <!-- Monthly Plan -->
                    <div class="bg-gradient-to-br from-red-600/10 to-red-800/10 rounded-lg p-5 border border-red-600 relative">
                        <div class="absolute -top-2.5 left-1/2 transform -translate-x-1/2">
                            <span class="bg-red-600 text-white text-xs font-semibold px-2.5 py-0.5 rounded-full">POPULAR</span>
                        </div>
                        <h3 class="text-lg font-semibold mb-2">Monthly</h3>
                        <div class="mb-3">
                            <span class="text-2xl md:text-3xl font-bold">$14.99</span>
                        ...
                        <button class="w-full py-2.5 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors text-sm">
                            Start Free Trial
                        </button>
                    </div>
                    <!-- Yearly Plan -->
                    <div class="bg-gray-800/30 rounded-lg p-5 border border-gray-700">
                        ...
                        <div class="mb-3">
                            <span class="text-2xl md:text-3xl font-bold">$119.99</span>
                            <span class="text-gray-400">/year</span>
                            <div class="text-sm text-red-400 mt-1">Save 33%</div>
                        </div>
                        <ul class="space-y-2 mb-4">
                            <li class="flex items-center">
                                <svg class="w-4 h-4 text-red-600 mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    <!-- Sign In Modal -->
    <div id="signin-modal" class="modal fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70">
        <div class="modal-content bg-gray-900 rounded-xl max-w-md w-full">
            <div class="p-5 border-b border-gray-700 flex justify-between items-center">
                <h2 class="text-xl md:text-2xl font-bold">Sign In</h2>
                <button id="close-signin-modal" class="text-gray-400 hover:text-white">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path>
                    </svg>
                </button>
            </div>
            <form id="signin-form" class="p-5">
                <div class="mb-3">
                    <label for="signin-email" class="block text-gray-300 mb-1.5 text-sm">Email</label>
                    <input type="email" id="signin-email" class="w-full px-3 py-1.5 bg-gray-800 border border-gray-700 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-red-600 text-sm" placeholder="your@email.com" required>
                    <div id="signin-email-error" class="text-red-400 text-xs mt-1 hidden">Please enter a valid email address</div>
                </div>
                <div class="mb-3">
                    <label for="signin-password" class="block text-gray-300 mb-1.5 text-sm">Password</label>
                    <input type="password" id="signin-password" class="w-full px-3 py-1.5 bg-gray-800 border border-gray-700 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-red-600 text-sm" placeholder="••••••••" minlength="8" required>
                    <div id="signin-password-error" class="text-red-400 text-xs mt-1 hidden">Password must be at least 8 characters</div>
                </div>
                <div class="flex items-center justify-between mb-4">
                    <div class="flex items-center">
                        <input type="checkbox" id="remember-me" class="w-3.5 h-3.5 text-red-600 bg-gray-800 border-gray-700 rounded focus:ring-red-600">
                        <label for="remember-me" class="ml-1.5 text-gray-300 text-sm">Remember me</label>
                    </div>
                    <a href="#" class="text-red-400 hover:text-red-300 text-xs">Forgot password?</a>
                </div>
                <button type="submit" class="w-full py-2.5 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors font-semibold text-sm">
                    Sign In
                </button>
                <div class="mt-3 text-center">
                    <span class="text-gray-400 text-sm">Don't have an account? </span>
                    <button type="button" id="switch-to-register" class="text-red-400 hover:text-red-300 text-sm">Register</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <!-- Register Modal -->
    <div id="register-modal" class="modal fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70">
        <div class="modal-content bg-gray-900 rounded-xl max-w-md w-full">
            <div class="p-5 border-b border-gray-700 flex justify-between items-center">
            ...
            <form id="register-form" class="p-5">
                <div class="mb-3">
                    <label for="register-name" class="block text-gray-300 mb-1.5 text-sm">Full Name</label>
                    <input type="text" id="register-name" class="w-full px-3 py-1.5 bg-gray-800 border border-gray-700 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-red-600 text-sm" placeholder="John Doe" required>
                    <div id="register-name-error" class="text-red-400 text-xs mt-1 hidden">Please enter your full name</div>
                </div>
                <div class="mb-3">
                    <label for="register-email" class="block text-gray-300 mb-1.5 text-sm">Email</label>
                    <input type="email" id="register-email" class="w-full px-3 py-1.5 bg-gray-800 border border-gray-700 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-red-600 text-sm" placeholder="your@email.com" required>
                    <div id="register-email-error" class="text-red-400 text-xs mt-1 hidden">Please enter a valid email address</div>
                </div>
                <div class="mb-3">
                    <label for="register-password" class="block text-gray-300 mb-1.5 text-sm">Password</label>
                    <input type="password" id="register-password" class="w-full px-3 py-1.5 bg-gray-800 border border-gray-700 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-red-600 text-sm" placeholder="••••••••" minlength="8" required>
                    <div id="register-password-error" class="text-red-400 text-xs mt-1 hidden">Password must be at least 8 characters</div>
                </div>
                <div class="mb-3">
                    <label for="register-confirm-password" class="block text-gray-300 mb-1.5 text-sm">Confirm Password</label>
                    <input type="password" id="register-confirm-password" class="w-full px-3 py-1.5 bg-gray-800 border border-gray-700 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-red-600 text-sm" placeholder="••••••••" minlength="8" required>
                    <div id="register-confirm-password-error" class="text-red-400 text-xs mt-1 hidden">Passwords do not match</div>
                </div>
                <div class="mb-4">
                    <div class="flex items-center">
                        <input type="checkbox" id="accept-terms" class="w-3.5 h-3.5 text-red-600 bg-gray-800 border-gray-700 rounded focus:ring-red-600" required>
                        <label for="accept-terms" class="ml-1.5 text-gray-300 text-sm">I accept the <a href="#" class="text-red-400 hover:text-red-300">Terms and Conditions</a></label>
                    </div>
                    <div id="accept-terms-error" class="text-red-400 text-xs mt-1 hidden">You must accept the terms and conditions</div>
                </div>
                <button type="submit" class="w-full py-2.5 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors font-semibold text-sm">
                    Create Account
                </button>
                <div class="mt-3 text-center">
                    ...
                    <button type="button" id="switch-to-signin" class="text-red-400 hover:text-red-300 text-sm">Sign In</button>
                </div>
            </form>
        </div>
    </div>
